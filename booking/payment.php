...
<html lang="">
	<head>
		...
		<title>TICKZY | Payment Info</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Tickzy Online Ticketing</a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="../User/index.html"><span class="glyphicon glyphicon-backward"></span> Back To Home</a></li>
    </ul>
  </div>
</nav>
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	<div class="panel-heading">
			 		<h3 class="panel-title"><center>TICKET INFO</center></h3>
			 	</div>
			 	<div class="panel-body">
			 		<strong>
			 			<i>Tickzy Online Ticket Booking , All Thanks From BCCI</i>
			 			<h3 id="match-name">
			 ...
			 <div class="panel panel-success">
				...
				VISITORS</strong>
					<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
						   ...
						   <center>
							   <a  href="../User/index.html" class="btn btn-success">Return Home
